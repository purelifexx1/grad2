...
#include <memory>
#include "../../control_application_2/detect.h"
...
QT_MOC_LITERAL(1, 7, 17), // "newPixmapCaptured"
QT_MOC_LITERAL(2, 25, 0) // ""

    },
    "detect\0newPixmapCaptured\0"
};
...
void detect::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (detect::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&detect::newPixmapCaptured)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject detect::staticMetaObject = { {
    QMetaObject::SuperData::link<QThread::staticMetaObject>(),
    qt_meta_stringdata_detect.data,
    qt_meta_data_detect,
    qt_static_metacall,
    nullptr,
    nullptr
