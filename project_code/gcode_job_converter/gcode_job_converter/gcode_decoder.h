...
#define NL file_content.append("\r");
typedef enum
{
    G00,
    G01,
...
public:
    ...
    void Gcode_Set_Offset(double x, double y, double z, double rx, double ry, double rz);
    ...
    Gcode_Decoder_DTC_TypeDef JobFile_Converter();
...
private:
    ...
    double x_off, y_off, z_off, rx_off, ry_off, rz_off;
};
